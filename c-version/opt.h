...
typedef enum { OPT_POSITIONAL, OPT_DELIMITED, OPT_FLEXIBLE } opt_MODE;
 ...
 *  optregp: sets character name, string name, brief description and
 * OPT_FLEXIBLE mode optexec: registers an 'exec function' (somthing that is
 * run, then exits)
 */
...
extern int OptRegister(char *v, opt_TYPE o, opt_MODE m, char c, char *n = 0,
                       char *B = 0);
...
extern int OptRegister(short *v, opt_TYPE o, opt_MODE m, char c, char *n = 0,
                       char *B = 0);
...
extern int OptRegister(unsigned short *v, opt_TYPE o, char c, char *n = 0,
                       char *B = 0);
extern int OptRegister(unsigned short *v, opt_TYPE o, char *n, char *B = 0);
extern int OptRegister(unsigned short *v, opt_MODE m, char c, char *n = 0,
                       char *B = 0);
extern int OptRegister(unsigned short *v, opt_MODE m, char *n, char *B = 0);
extern int OptRegister(unsigned short *v, opt_TYPE o, opt_MODE m, char c,
                       char *n = 0, char *B = 0);
extern int OptRegister(unsigned short *v, opt_TYPE o, opt_MODE m, char *n,
                       char *B = 0);
...
extern int OptRegister(int *v, opt_TYPE o, opt_MODE m, char c, char *n = 0,
                       char *B = 0);
...
extern int OptRegister(unsigned long *v, opt_TYPE o, char c, char *n = 0,
                       char *B = 0);
extern int OptRegister(unsigned long *v, opt_TYPE o, char *n, char *B = 0);
extern int OptRegister(unsigned long *v, opt_MODE m, char c, char *n = 0,
                       char *B = 0);
extern int OptRegister(unsigned long *v, opt_MODE m, char *n, char *B = 0);
extern int OptRegister(unsigned long *v, opt_TYPE o, opt_MODE m, char c,
                       char *n = 0, char *B = 0);
extern int OptRegister(unsigned long *v, opt_TYPE o, opt_MODE m, char *n,
                       char *B = 0);
...
extern int OptRegister(double *v, opt_TYPE o, opt_MODE m, char c, char *n = 0,
                       char *B = 0);
...
extern int OptRegister(long *v, opt_TYPE o, opt_MODE m, char c, char *n = 0,
                       char *B = 0);
...
extern int OptRegister(unsigned int *v, opt_TYPE o, char c, char *n = 0,
                       char *B = 0);
extern int OptRegister(unsigned int *v, opt_TYPE o, char *n, char *B = 0);
extern int OptRegister(unsigned int *v, opt_MODE m, char c, char *n = 0,
                       char *B = 0);
extern int OptRegister(unsigned int *v, opt_MODE m, char *n, char *B = 0);
extern int OptRegister(unsigned int *v, opt_TYPE o, opt_MODE m, char c,
                       char *n = 0, char *B = 0);
extern int OptRegister(unsigned int *v, opt_TYPE o, opt_MODE m, char *n,
                       char *B = 0);
extern int OptRegister(char **v, char c, char *n = 0, char *B = 0);
extern int OptRegister(char **v, char *n, char *B = 0);
extern int OptRegister(char **v, opt_TYPE o, char c, char *n = 0, char *B = 0);
...
extern int OptRegister(float *v, opt_TYPE o, opt_MODE m, char c, char *n = 0,
                       char *B = 0);
...
extern int OptRegister(unsigned char *v, opt_TYPE o, char c, char *n = 0,
                       char *B = 0);
extern int OptRegister(unsigned char *v, opt_TYPE o, char *n, char *B = 0);
extern int OptRegister(unsigned char *v, opt_MODE m, char c, char *n = 0,
                       char *B = 0);
extern int OptRegister(unsigned char *v, opt_MODE m, char *n, char *B = 0);
extern int OptRegister(unsigned char *v, opt_TYPE o, opt_MODE m, char c,
                       char *n = 0, char *B = 0);
extern int OptRegister(unsigned char *v, opt_TYPE o, opt_MODE m, char *n,
                       char *B = 0);
#endif /*__cplusplus */
