...
#include "ntp.h"
//
inline void ntp_assert_f(FILE* stream, const char* a, const char* op, const char* b, const char a_value[A_VALUE_STRING],
...
extern inline void ntp_assert_f(FILE* stream, const char* a, const char* op, const char* b, const char a_value[A_VALUE_STRING],
